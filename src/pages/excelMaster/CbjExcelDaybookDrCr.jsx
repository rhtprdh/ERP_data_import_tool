...
// ]);
  ...
  const csvFormate= ()=>{
        csvFormateData.push({
          ...
          'AAA05' : 'Round Off',
          'AAA06' : 'Input IGST 18%',
          'AAA07' : 'Purchase of abc item',
          'AAA08' : 'Input IGST 5%',
          'AAA09' : 'Purchase of abc item',
          'AAA10' : 'Output IGST 18%',
          'AAA11' : 'Purchase of abc item',
          'AAA12' : 'Input GST Compensation Cess',
          'AAA13' : 'Input CGST 2.5%',
          'AAA14' : 'Input SGST - 2.5%',
          'AAA15' : 'Output IGST - 5%',
          'AAA16' : 'Consumables',
    ...
    XLSX.writeFile(newWorkbooka, 'Tally_ERP_Data_Formate.xlsx');
                            ...
                            if(row[acc_code_clm[is]].endsWith(' Dr')){
                                ...
                                newData.push({ 
                                    ...
                                    'slno' :  slno++,
                                     ...
                                     'dramt' : parseFloat(row[acc_code_clm[is]].replace(/ Dr$/, '')),
                                     'cramt' :null,
                                     ...
                                     'tcode' : tranType ==='Receipt'? 'T' : tranType ==='Payment'? 'B' : tranType ==='Journal'? 'J' : tranType ==='Purchase'?'P': tranType ==='Sale'?'S' :'',
                                     'base_tcode' : tranType ==='Receipt'? 'B' : tranType ==='Purchase'?'P' : tranType ==='Sale'?'S':'',
                                     'evrdate' : null,
                                     'durdate' : null,
                                     'dralloc' : parseFloat(row[acc_code_clm[is]].replace(/ Dr$/, '')),
                                     'cralloc' : null,
                                     'ASDRALLOC' : null,
                                     'ASCRALLOC' : null,
                                     'BANKID' : tranType ==='Payment'? bank_id : '',
                                     'INSTYPE' :  tranType ==='Payment'? 'NA' : tranType ==='Journal'? 'NA'  :'',
                                     'CHQNO' : null,
                                     'CHQDATE' : null,
                                     'BANKDATE' : tranType ==='Payment'?  await dateFormate(row.Date) : '',
                                     'LASTUPDATE' :  await dateFormate(row.Date),
                                     'QTYISSUED' : null,
                                     'QTYRECD' : row.Quantity? parseFloat(row.Quantity):'',
                                     'REVACC_CODE' : tranType ==='Payment'? PostCodeValue: '',
                                     'COST_CODE' : null,
                                     'CONSIGNEE_CODE' : null,
                                     'STAX_CODE' : null,
                                     'ETAX_CODE' : null,
          ...
          <div>
            ...
            {!isTableOpen &&
              ...
              onChange={(e) => setTokenVrSeq(e.target.value)}/> */}
                ...
                <Button className="float-right mr-5" children='Process' onClick={processData}/>
...
export default CbjExcelDaybookDrCr;
